...
const data = {
    ...
    //home.js
/*     function todosLosEventos(eventos){
...
// eventos llama al array (data.events) y evento (cada objeto iterado)
...
/* function templatesCards(aiuda){
    return (`
<div class="card" style="width: 16rem;">
<img src="${data.events.image}" class="card-img-top" alt="${data.events.name}">
<div class="card-body">
<h5 class="card-title">${data.events.name}</h5>
<p class="card-text">${data.events.date}</p>
...
/* todosLosEventos(imagenes, data) */




//imagenes.push(templatesCards(walk))